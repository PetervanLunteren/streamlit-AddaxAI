...
def render_export_popover(export_col, data_frame, label_prefix="Observations"):
...
if current_view == "Files":
    ...
    render_export_popover(export_col, files_df, "Files")
    st.stop()
    ...
    render_export_popover(export_col, df_to_export, "Observations")
    ...
    selected_size = st.session_state.get("browser_image_size_control", DEFAULT_SIZE_OPTION)
