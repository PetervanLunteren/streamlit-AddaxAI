"""
AddaxAI Duplicate Removal Tool

Tool for eliminating redundant images and repeat detections from camera trap datasets.
Integrates repeat detection elimination algorithms to reduce false positives from static objects.

TODO: Implement MegaDetector RDE integration for Streamlit interface.
"""
