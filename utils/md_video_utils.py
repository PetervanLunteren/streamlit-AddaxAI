...
# This script is taken from https://github.com/agentmorris/MegaDetector/blob/main/megadetector/detection/video_utils.py
# it is copy-pasted here to avoid adding a dependency on megadetector for every classification model environment, which would cause package conflicts
# it has not been modfied except for outcommenting megadetector dependencies
# Peter van Lunteren 2025-09-19
